        ...
        <div class="row gx-0">
            <div class="col-md-6 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center">
                    <small class="py-2"><i class="far fa-clock text-primary me-2"></i>Horas abertas: Segunda - Sábado : 6.00 am - 10.00 pm, Domingo fechado </small>
                </div>
            </div>
    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">Agendamento</h1>
                <a href="" class="h4 text-white">Início</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h4 text-white">Agedamento</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
                ...
                <div class="col-lg-6 py-5">
                    <div class="py-5">
                        ...
                        <p class="text-white mb-0">
                            Conheça os Tratamentos da maior rede de clínicas odontológicas do Mundo. Fique por dentro de nossos seviços e agende sua consulta.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="appointment-form h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                        <h1 class="text-white mb-4">Faça agendamento</h1>
                        <form>
                            <div class="row g-3">
                                <div class="col-12 col-sm-6">
                                    <select class="form-select bg-light border-0" style="height: 55px;">
                                        <option selected>Seleciona um serviço</option>
                                        <option value="1">Implante dentário</option>
                                        <option value="2">Odontologia estética</option>
                                ...
                                <div class="col-12 col-sm-6">
                                    <select class="form-select bg-light border-0" style="height: 55px;">
                                        ...
                                        <option value="1">Dentista Alyce Barbosa</option>
                                        <option value="2">Dentista Kauan Gomes</option>
                                        <option value="3">Dentista Luís Fabiano</option>
                                    </select>
                                </div>
                                <div class="col-12 col-sm-6">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="date" id="date1" data-target-input="nearest">
                                        <input type="text" class="form-control bg-light border-0 datetimepicker-input" placeholder="Data de agendamento" data-target="#date1" data-toggle="datetimepicker" style="height: 55px;">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="time" id="time1" data-target-input="nearest">
                                        <input type="text" class="form-control bg-light border-0 datetimepicker-input" placeholder="Agendar Horário" data-target="#time1" data-toggle="datetimepicker" style="height: 55px;">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button class="btn btn-dark w-100 py-3" type="submit">Faça agendamento</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div class="container-fluid bg-dark text-light py-5 wow fadeInUp" data-wow-delay="0.3s" style="margin-top: -75px;">
        <div class="container pt-5">
            <div class="row g-5 pt-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <h3 class="text-white mb-4">Links principais</h3>
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Últimas postagens</a>
                        <a class="text-light" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Contato</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <h3 class="text-white mb-4">Informações de contato</h3>
                    <p class="mb-2"><i class="bi bi-geo-alt text-primary me-2"></i>Canindé, Ceará, Brasil</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <h3 class="text-white mb-4">Siga a gente</h3>
                    <div class="d-flex">
