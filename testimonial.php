...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="../login/login/index.php" class="btn btn-primary py-2 px-4 ms-3">Login</a>
        </div>
    </nav>
    <!-- Navbar End -->
    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">Destaques em atendimentos</h1>
                <a href="" class="h4 text-white">Início</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h4 text-white">Profissionais</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
